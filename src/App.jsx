...
function App() {
  ...
  return (
    <div className="h-screen w-screen overflow-y-auto flex items-center justify-center  p-10 ">
      <div className="bg-bgLightGlass w-auto p-6 pt-10 h-auto md:flex  absolute z-50 rounded-2xl backdrop-blur-2xl shadow-md">
		<div>
		...
		<div className="flex flex-col md:block items-center" >
          ...
          <div className="mt-4 relative">
            ...
            <a
              ...
              className="bg-bgLight p-3 font-creatobold rounded-lg absolute top-40 font-semibold "
            >
              Download Image
            </a>
          </div>
      ...
      {/* Background Animation */}
		<div clasName="relative h-screen w-screen overflow-hidden " >
			<div className="absolute w-80 h-80 md:w-1/4  md:h-2/4 top-0 left-0 z-0 rounded-full blur-3xl xs:animate-xsPosMove md:animate-posMove bg-[#66347F]"></div>
			<div className="absolute w-80 h-80 md:w-1/4 md:-2/4 top-80 right-0 z-0 rounded-full blur-3xl xs:animate-xsNegMove md:animate-negMove bg-[#8CC0DE]"></div>
		</div>
    </div>
  );
}
